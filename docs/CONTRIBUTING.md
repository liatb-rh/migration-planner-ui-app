# Contributing to Migration Planner UI App
...
- **Comments:** Add comments where the code logic is not immediately obvious. Explain _why_ a particular approach was taken, not just _what_ the code does.
